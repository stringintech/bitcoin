...
class HeadersSyncTest(BitcoinTestFramework):
    ...
    def test_normal_peer_timeout(self, best_header_time):
    ...
    def test_noban_peer_timeout(self, best_header_time):
    ...
    def send_new_header(self):
        self.log.info("Create new block to send its header")
        node = self.nodes[0]
        ...
        b = create_block(tip_hash, create_coinbase(tip_height + 1), new_block_time)
        b.solve()

        self.log.info("Send the new block header to establish new best header")
    ...
    def run_test(self):
        ...
        best_header_time = self.send_new_header()
        self.test_normal_peer_timeout(best_header_time)
        self.test_noban_peer_timeout(best_header_time)
